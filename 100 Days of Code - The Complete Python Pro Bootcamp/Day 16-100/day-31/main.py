...
language = canvas.create_text(CAN_X / 2, CAN_Y / 4, text="German", fill="black", font=(FONT_NAME, 30, "italic"))
guess_word = canvas.create_text(CAN_X / 2, CAN_Y / 2, text="German", fill="black", font=(FONT_NAME, 60, "bold"))
